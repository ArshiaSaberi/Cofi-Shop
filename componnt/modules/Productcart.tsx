...
import Boutoon from "./buttoncart";
...
export default function Productcart({ item, onUpdate }: ProductcartProps) {
  ...
  return (
    <div className="overflow-x-hidden flex gap-4 pb-6">
      <div className="flex-col justify-center flex gap-4">
        ...
        <div>
          <Boutoon value={data} onUpdate={onUpdate} />
        </div>
      </div>
      <div className="flex-col flex justify-between">
        ...
        <div className="mr-3 h-[40px] flex items-center text-Yekan">
          {(item.price * item.quantity).toLocaleString()}
          <span className="mr-1 text-xs text-gray-500">   <svg
